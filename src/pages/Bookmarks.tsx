...
const bookmarks: Bookmark[] = [
  ...
  },
  {
    ...
    tag: "react",
    text: ["Use Encapsulation", "Why Your React Components Should Only Use Custom Hooks"],
  },
  {
  ...
  },
  {
    ...
    tag: "web development",
    text: ["Better Auth", "The comprehensive authentication framework for TypeScript"],
  },
  {
  ...
  },
  {
    ...
    tag: "repo",
    text: ["dreamsofcode-io/dotfiles", "dotfile configuration for a consistent experience."],
  },
  {
    href: "https://blog.sentry.io/introducing-user-feedback-the-easiest-way-to-connect-with-your-users/",
    tag: "docs",
    text: ["Sentry's User Feedback Widget", "Allows users to submit feedback quickly and easily"],
  },
  {
  ...
  },
  {
    ...
    tag: "gaming",
    text: ["Greenlight", "Open-source client for xCloud and Xbox home streaming"],
  },
  {
    href: "https://astro.build/",
    tag: "web development",
    text: ["Astro", "Web framework optimized for building fast, content-driven websites"],
  },
  {
  ...
  },
  {
    ...
    tag: "CSS-in-TS",
    text: ["Class Variance Authority", "Library for building type-safe UI components"],
  },
  {
  ...
  },
  {
    ...
    tag: "deno",
    text: ["Fresh", "Next generation web framework, built for speed, reliability, and simplicity"],
  },
  {
        ...
        <nav>
          <ul>
            {bookmarks.map(({ href, text, tag }) => (
              <li
                className={cx("group flex transition-colors even:bg-ctp-mantle rounded")}
                key={href}
              >
                <a
                  href={href}
                  target="_blank"
                  className={cx(
                    "flex w-full flex-col px-6 py-4 gap-1 text-ctp-text transition relateive",
                ...
                >
                  <span className="flex gap-4 justify-between items-center">
                    <span className="font-medium transition-colors">{text.at(0)}</span>
                    {tag && (
                      <span className="text-ctp-subtext1 transition-colors text-sm rounded-xl px-2 border border-ctp-surface1">
                        {tag}
                      </span>
                    )}
                  </span>
