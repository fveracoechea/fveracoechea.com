    ...
    <div className="pb-12 pt-8">
      <section class="flex flex-col items-center gap-8 rounded pb-20 md:flex-row md:pt-10">
        <div className="flex flex-1 flex-col gap-4">
          <h2 className="text-4xl !leading-[1.15] md:text-5xl">
            ...
            <i className="text-ctp-flamingo">ideas</i>{" "}
      ...
      <section className="flex flex-col gap-6 pb-20">
        <p className="prose text-lg">
          Hello there! I'm Francisco, a web engineer passionate about
          experimenting, learning, and building. This is my corner of the web
          where I share things I find worth sharing.
        </p>
        <ul
