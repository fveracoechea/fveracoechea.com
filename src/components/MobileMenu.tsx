  ...
  return (
    <>
      ...
      <nav
        ...
        style={{ height: 0 }}
        className={cx(
          open && "border-y border-y-ctp-surface0",
      ...
      >
        <ul ref={ulRef} className="flex flex-col gap-2 p-4">
          <li>
            <a
              href="/#articles"
              className="flex flex-1 rounded px-4 py-2 text-base hover:bg-ctp-overlay2/10 active:text-ctp-blue active:ring-2 active:ring-ctp-overlay2"
            >
              Articles
            </a>
          </li>
          <li>
            <hr className="border-t border-t-ctp-surface0" />
          </li>
          <li>
            <a
              href="/bookmarks/"
