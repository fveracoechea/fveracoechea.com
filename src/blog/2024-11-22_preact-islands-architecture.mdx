...
description:
  Understanding the islands architecture, a step by step implementation with
  Preact.
...
about how this type of optimizations work, as it can be done in most types of
...
think it may be ok if we're talking about a small personal site.
